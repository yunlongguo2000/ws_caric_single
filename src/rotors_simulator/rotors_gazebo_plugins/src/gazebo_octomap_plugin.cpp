...
namespace gazebo
{
  ...
  bool OctomapFromGazeboWorld::ServiceCallback( rotors_comm::Octomap::Request &req, rotors_comm::Octomap::Response &res )
  {
    gzlog << "Creating octomap with origin at"
          << " (" << req.bounding_box_origin.x
          << ", " << req.bounding_box_origin.y
          << ", " << req.bounding_box_origin.z
          << "), and bounding box lengths"
          << " (" << req.bounding_box_lengths.x
